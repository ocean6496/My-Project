        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="panel panel-back noti-box">
                    ...
                    <div class="text-box">
                        <p class="main-text"><a href="/admin/category/index.php" title="">Quản lý truyện</a></p>
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="panel panel-back noti-box">
                    ...
                    <div class="text-box">
                        <p class="main-text"><a href="/admin/category/index.php" title="">Quản lý người dùng</a></p>
